...
- **Performance (NFR1–NFR4):** incremental rendering, sustained typing
  ...
  timeout).
- **Resource Consumption (NFR9–NFR12):** 6400 B code budget (amended 2026-05-17 from the prior 5760 B; itself amended 2026-05-16 from 5 KB; itself amended 2026-05-15 from 3 KB tentative),
...
3. **The 6400 B code budget (NFR9, amended 2026-05-17 from the prior 5760 B; itself amended 2026-05-16 from 5 KB; itself amended 2026-05-15 from 3 KB) and crash-free contract (NFR5)
...
- Listing and symbol files emitted into a non-tracked location for
  size auditing against the 6400 B budget (NFR9, amended 2026-05-17 from the prior 5760 B; itself amended 2026-05-16 from 5 KB; itself amended 2026-05-15 from 3 KB).
...
~1.8 KB into the 6400 B code envelope (NFR9). The shared `dispatch_key`
...
│   ├── vibe.lst             # Listing — per-section size audit (NFR9; 6400 B ceiling)
